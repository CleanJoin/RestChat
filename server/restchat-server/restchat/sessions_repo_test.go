...
func TestRemoveIndexSession(t *testing.T) {
	...
	request := RemoveIndexSession(sessionmemrep.Sessions, 1)
...
func TestReceivelastIDSession(t *testing.T) {
	...
	if ReceivelastIDSession(usmr) != 4 {
