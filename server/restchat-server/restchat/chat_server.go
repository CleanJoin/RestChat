...
import (
	...
	"net/http"
	"regexp"
	_ "restchat-server/docs" // docs folder path generated by swag init
	"time"
...
func (chat *ChatServerGin) Use(sessionStorage ISessionStorage, userStorage IUserStorage, messageStorage IMessageStorage) {
	...
	chat.router.GET("/swagger/*any", ginSwagger.WrapHandler(swaggerFiles.Handler))
...
// @Produce json
// @Param MessageSend body RequestMessage true "User Data"
